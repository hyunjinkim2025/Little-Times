...
function shareAlbum() {
  ...
  const message = "공유할 플랫폼을 선택하세요:\\n1. 페이스북\\n2. 트위터\\n3. 카카오스토리";
  const choice = prompt(message);
  if (choice === "1") window.open(shareLinks[0], "_blank");
  if (choice === "2") window.open(shareLinks[1], "_blank");
  if (choice === "3") window.open(shareLinks[2], "_blank");
}
